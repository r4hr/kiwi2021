...
Participación según el género de los participantes.
...
En resumen, más de dos tercios de las personas que participaron de esta encuesta son mujeres cis.
...
kiwi21_original %>% 
  ...
  rename("Género" = genero, 
         "Cantidad" = n) %>% 
  kbl(caption = "Participantes según\nIdentidad de Género") %>% 
  kable_styling(full_width = F, position = "center",
                bootstrap_options = c("striped", "hover", "condensed", "responsive")) %>% 
